    ...
    <div>
      ...
      <div id="page-top">
          ...
          <Container>
            <Row>
              <div className="col-lg-4 mb-5 mb-lg-0">
                ...
                <p className="lead mb-0">Encarnación, Paraguay</p>
              </div>
              <div className="col-lg-4 mb-5 mb-lg-0">
                <h4 className="text-uppercase mb-4">{f("around_the_web")}</h4>
                <a
                  className="btn btn-outline-light btn-social mx-1"
                  href="https://www.facebook.com/rodrigopaszniuk"
                >
                  <FontAwesomeIcon icon={["fab", "facebook"]} />
                </a>
                <a
                  className="btn btn-outline-light btn-social mx-1"
                  href="https://twitter.com/rodrigopaszniuk"
                >
                  <FontAwesomeIcon icon={["fab", "twitter"]} />
                </a>
                <a
                  className="btn btn-outline-light btn-social mx-1"
                  href="https://www.linkedin.com/in/rodrigo-paszniuk-b879b956/"
                >
                  <FontAwesomeIcon icon={["fab", "linkedin"]} />
                </a>
                <a
                  className="btn btn-outline-light btn-social mx-1"
                  href="https://github.com/rpaszniuk"
                >
                  <FontAwesomeIcon icon={["fab", "github"]} />
                </a>
                <a
                  className="btn btn-outline-light btn-social mx-1"
                  href="https://www.youtube.com/user/rpaszniuk"
                >
        ...
        <div className="copyright py-4 text-center text-white">
          <Container>
            <small>
              Copyright © Rodrigo Paszniuk {new Date().getFullYear()}
            </small>
          </Container>
        </div>
      </div>
